	...
	<div class="list-group">
		<ul class="list-group">
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/user/myarticleList">我的文章 </a></li>
			<li class="list-group-item  text-center"><a class="channel"
			...
			<!-- 我的投票 开始-->
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/vote/list">我的投票 </a></li>
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/vote/push" class="list-group-item">发布投票</a></li>
			<!-- 我的投票 结束-->

			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" class="list-group-item"
				data="/user/myComment">我的评论</a></li>
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" class="list-group-item"
				data="/user/toAddhead_picture">上传头像</a></li>
			<li class="list-group-item  text-center"><a class="channel"
			...
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/blog/toList"
				class="list-group-item">博客管理</a></li>
